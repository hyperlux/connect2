    ...
    <div className="bg-white dark:bg-dark-card rounded-xl shadow-sm">
      <div className="p-4 border-b dark:border-gray-700">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-gray-900 dark:text-dark-primary">Active Proposals</h2>
          </div>
      ...
      <div className="divide-y dark:divide-gray-700">
        {activeProposals.map((proposal) => (
          <div key={proposal.id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-dark-card">
            ...
            <div className="mt-3">
              ...
              <div className="flex items-center justify-between text-sm text-gray-600 dark:text-dark-secondary">
